const SocialImpactStatsCard = ({
  ...
  <div className="flex flex-col justify-center items-center gap-y-3 max-sm:not-last-of-type:pb-8">
    <h2 className="text-[clamp(3rem,16vw,4.5rem)] text-[#eef5d3] dark:text-dark-contrast-100 font-black -tracking-widest">{value}</h2>
    <h3 className="text-chocolate-300 dark:text-dark-contrast-200 text-center font-semibold uppercase">{title}</h3>
