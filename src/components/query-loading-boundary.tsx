...
const QueryLoadingBoundary = ({ children }: QueryLoadingBoundaryProps) => {
  return (
    <Suspense
      fallback={
        <div className="bg-tan-950 dark:text-dark-950 h-svh w-full flex justify-center items-center">
          <div className="flex flex-col justify-center items-center gap-y-4 animate-pulse">
            ...
            <h3 className="text-xl text-chocolate-300 dark:text-dark-contrast-100">Carregando...</h3>
          </div>
        </div>
      }
    >
