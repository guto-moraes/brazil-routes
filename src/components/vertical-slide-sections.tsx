...
const VerticalSlideSections = () => {
  ...
  return (
    <>
      <section
        className="sticky-chapters bg-chocolate-300 relative h-svh w-full flex max-lg:flex-col"
      ...
      >
        ...
        <Col className="max-lg:flex-row gap-6">
          <div className="service-img-wrapper relative w-[60%] h-100 overflow-hidden [clip-path:polygon(50% 0, 100% 0, 100% 85%, 90% 100%, 50% 100%, 0 100%, 0 0)] max-lg:w-[25%]">
...
export default VerticalSlideSections;
