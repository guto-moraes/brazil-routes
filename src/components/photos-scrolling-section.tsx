      ...
      <section className="photos-container relative bg-tan-800 h-svh w-full overflow-hidden z-30" ref={refContainer}>
        <div className="intro-text absolute inset-0 flex flex-col items-center justify-center gap-y-8">
          ...
          <p className="indent-10 text-2xl text-chocolate-100 text-justify text-pretty hyphens-auto w-full xl:max-w-5xl">
            A memória das pessoas que viveram durante os anos de atuação da FBC no leste de Mato Grosso constitui,
            dentre outros aspectos, é uma importante fonte para se compreender e analisar o passado daquele lugar. Pois,
            embora raramente sejam encontradas na documentação escrita, os eventos que tais memórias ajudam a recompor
            também fazem parte do processo de formação histórica e social da região do Vale do Araguaia.
          </p>
        </div>
