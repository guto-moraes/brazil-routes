  ...
  return (
    <h2
      className={cn(
        ...
        "[transition:background-size_cubic-bezier(.1,.5,.5,1)_0.5s] duration-300 flex flex-col justify-center items-start group uppercase",
      )}
    >
      {text}
      <span
        className={cn(
          ...
          "group-hover:[clip-path:polygon(0%_0%,100%_0%,100%_100%,0%_100%)] duration-300 transition-all",
        )}
      >
        {spanText}
      </span>
