...
<>
    <article
      className={cn(
        ...
        "[&_h2.wp-block-heading]:text-[clamp(1.15rem,6vw,1.35rem)] [&_h2.wp-block-heading]:text-blue-retro-700", // Elementos H2
        ...
        "[&_figure.wp-block-gallery.is-layout-flex]:grid! [&_figure.wp-block-gallery.is-layout-flex]:grid-cols-2!", // Galeria de Imagens
        ...
        "[&_ol]:text-tan-800 [&_ul]:text-tan-800 [&_ol]:list-decimal [&_ul]:not-last:mb-12 [&_ul]:ml-6 [&_ul]:list-disc [&_ul_li]:mb-2", // Elementos de Listas
        "dark:selection:bg-dark-contrast-100 dark:selection:text-bone-900", // >>>>>>>> Início das colres para a versão do tema contraste <<<<<<<<<
        "dark:[&_h2.wp-block-heading]:text-blue-retro-300", // Elemento H2
        "dark:[&_p]:text-white", // Elemento Parágrafo
        "dark:[&_a]:text-dark-contrast-100 dark:[&_a]:hover:text-dark-contrast-100/70", // Elemento Anchor
        "dark:[&_.wp-block-footnotes]:text-dark-200", // Elemento OL (notas de rodapé)
        "[&_.wp-block-separator]:border-dark-800", // Elemento HR
        "dark:[&_.wp-block-quote_p]:bg-dark-800 [&_.wp-block-quote_p]:border-blue-retro-500", // Elemento Blockquote
        "dark:[&_ol]:text-white dark:[&_ul]:text-white", // Elementos de Listas
        "dark:[&_.wp-block-table_table_thead]:bg-dark-800 dark:[&_.wp-block-table_table_th]:text-blue-retro-400", // Elemento Tabela
