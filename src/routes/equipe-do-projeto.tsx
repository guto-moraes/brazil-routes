          ...
          <ScrollRotateContent>
            <div className="container mx-auto h-full px-4 py-16">
              ...
              <ArticleChapterContent
                className="columns-2 gap-8 mt-16"
                content={`
                ...
                <p>Enfim, para além do comprometimento, este projeto tem sido efetivamente executado por meio de pessoas que dispuseram suas habilidades e assumiram responsabilidades para que ele, o projeto, se tornasse uma realidade.</p>
                <p class="text-center! text-terracotta-800! font-bold">Quer saber quem são essas pessoas? Role a página para saber mais.</p>
                `}
              />
            </div>
          </ScrollRotateContent>
