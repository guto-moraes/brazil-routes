          ...
          <div className="main-menu shrink w-full flex justify-end">
            <ul role="menu" className="flex justify-end items-center gap-8">
              <li role="presentation">
                <Link activeProps={{ className: "text-terracotta-500 font-bold" }} to="/" role="menu-item" title="Página Inicial">
                  Página Inicial
                </Link>
              </li>
              <li role="presentation">
                <Link activeProps={{ className: "text-terracotta-500 font-bold" }} to="/sobre-o-projeto" role="menu-item" title="Sobre o Projeto">
                  Sobre o Projeto
                </Link>
              </li>
            </ul>
